...
async def _(event):
    ...
    if event.is_group:
     if not (await is_register_admin(event.input_chat, event.message.sender_id)):
       await event.reply(" Need Admin Pewer.. You can't use this command.. But you can use in my [Pm](http://t.me/EzilaXBot)")
       return
    ...
    try:
        ...
        tts.save("TalkWithEzilaXBot.mp3")
        ...
        return
    with open("TalkWithEzilaXBot.mp3", "r"):
        await tbot.send_file(
            event.chat_id, "TalkWithEzilaXBot.mp3", voice_note=True, reply_to=reply_to_id
        )
        os.remove("TalkWithEzilaXBot.mp3")
