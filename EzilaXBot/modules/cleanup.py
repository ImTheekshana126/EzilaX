...
import EzilaXBot.modules.sql.global_bans_sql as gban_sql
import EzilaXBot.modules.sql.users_sql as user_sql
from EzilaXBot import DEV_USERS, OWNER_ID, dispatcher
